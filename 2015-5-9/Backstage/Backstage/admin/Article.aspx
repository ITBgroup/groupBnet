<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="Article.aspx.cs" Inherits="Backstage.admin.WebForm2" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="Search" runat="server" Text="搜索" OnClick="Search_Click" style="height: 21px" />
     ...
     <%#Eval("Title")%>
        <asp:Repeater ID="Article" runat="server" OnItemCommand="Article_ItemCommand">
            ...
            <ItemTemplate>
                ...
                <td>
                    <asp:LinkButton runat="server" ID="deleteLink" CommandName="delete" CommandArgument='<%#Eval("ID")%>' OnClientClick="if(window.confirm('你确定要删除?')){ return true;}else{return false;}">删除</asp:LinkButton>
                </td>
                <br /><br />
            </ItemTemplate>
