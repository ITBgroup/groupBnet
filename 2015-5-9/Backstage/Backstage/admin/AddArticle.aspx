<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddArticle.aspx.cs" Inherits="Backstage.admin.AddArticle" ValidateRequest="false"%>
...
<body>
   ...
   <div id="menu" style="min-height:513px">
    ...
    <div id="change" class="source">
         <span class="auto-style1">文章标题：</span><asp:TextBox ID="myTitle" runat="server" Height="23px" Width="541px"></asp:TextBox>
        <span class="auto-style1">作者：<asp:TextBox ID="Author" runat="server" Height="23px" Width="197px"></asp:TextBox>
        <br />
        类别：<asp:DropDownList ID="ClassList" runat="server" Height="26px" style="margin-bottom: 0px; font-size: large;" Width="112px">
        </asp:DropDownList>
        </span>
        <br />
